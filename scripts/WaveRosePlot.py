...
from scripts.Initial import Initializer, hgt_labels, dir_labels

from plotly.subplots import make_subplots

howtoread = """
<b>How to Read the Wave Rose</b><br><br>
<b>Direction:</b> Each spoke points in the direction waves are coming FROM, 
oriented clockwise.<br><br>
<b>Length:</b> The longer the spoke, the more frequently waves arrived 
from that direction.<br><br>
<b>Color:</b> Each color band represents a wave height range (ft). 
Light cyan = small calm waves, dark navy = largest wave heights.<br><br>
"""
...
class WavePlot(Initializer):
    def buildGrid(self, results, fname, rows=3, cols=2):
        ...
        fig.update_layout(
            ...
            margin = dict(t=280),
            legend_title_text = "Wave Height (ft)",
    ...
    def save(self, fig, fname):
        output_dir = r"C:\Users\ncbof\hypoxia\waveroseproj\dataOutput"
